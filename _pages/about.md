...
# 🔥 News
- *2026.07*: &nbsp;🎉🎉 Our paper "HyperPIM: A Redundancy-Aware Heterogeneous PIM Accelerator for Hypergraph Neural Networks" is accepted by IEEE TCAD!
...
- **[ISCA 2026]** [TAGT: An Efficient Graph Transformer Accelerator with Topology-aware Sparsification and Merging](https://ieeexplore.ieee.org/document/11617945) ```CCF A``` <br /> Hui Yu, Wei Zhang, Ligang He, **<ins>Jin Zhao</ins>**, Yu Zhang, Zixiao Wang <br /> ***Proceedings of the 53rd Annual International Symposium on Computer Architecture***, 2026
...
- **[WWW 2026]** [LNAHC: Lightweight Neural Attributed Hypergraph Clustering via Multi-hop Attributed HNCut]() ```CCF A``` <br /> Yihan Wang, Longlong Lin, **<ins>Jin Zhao</ins>**, Zeli Wang  <br />  ***Proceedings of the 2026 ACM Web Conference***, 2026
- **[WWW 2026]** [Scalable and Provable Biclique-Preserving Clustering: The Power of Counting-based Approaches](https://dl.acm.org/doi/epdf/10.1145/3774904.3792116) ```CCF A``` <br /> Longlong Lin, Zeli Wang, Rong-Hua Li, Xiaohai Dai, Li Ni, **<ins>Jin Zhao</ins>**  <br />  ***Proceedings of the 2026 ACM Web Conference***, 2026
- **[IEEE TCAD]** [HyperPIM: A Redundancy-Aware Heterogeneous PIM Accelerator for Hypergraph Neural Networks](https://doi.org/10.1109/TCAD.2026.3718794) ```CCF A``` <br /> Zhongtian Long, Wenju Zhao, Mo Zou, Hongrui Guo, **<ins>Jin Zhao (Corresponding author)</ins>**, Qiyuan Niu, Yutao Fu, Shunsen Lv, Zixiao Wang, Yuluo Guo, Yongwei Zhao, Yu Zhang, Hai Jin <br /> ***IEEE Transactions on Computer-Aided Design of Integrated Circuits & Systems***, 2026
- **[IEEE TMC]** [Fair and Efficient Resource Allocation in UAV-Enhanced Edge Computing: A Dual-Layer Auction Approach]() ```CCF A``` <br /> Li Lin, Heming Jiang, Jinbo Xiong, **<ins>Jin Zhao</ins>**, Peng Li, Xuan Li, Limei Lin, Deze Zeng <br /> ***IEEE Transactions on Mobile Computing***, 2026
...
- **[ICCD 2026]** [ReHyper: A Redundancy-Eliminated Accelerator for Dynamic Hypergraph Neural Networks]() ```CCF B``` <br /> Zhongtian Long, Mo Zou, Qiyuan Niu, Wenju Zhao, Yutao Fu, Jiaqi Zhai, Shunsen Lv, Zixiao Wang, Yuluo Guo, Yuanyuan Liang, Hongrui Guo, **<ins>Jin Zhao</ins>**, Yu Zhang <br /> ***Proceedings of the 44th IEEE International Conference on Computer Design***, 2026
- **[APPT 2026]** [Hardware-Accelerated Streaming Graph Processing with Fast Refinement](https://link.springer.com/chapter/10.1007/978-981-92-4805-6_30) <br /> Jingrui Yuan, Qinggang Wang, Haoran Zhu, **<ins>Jin Zhao</ins>**, Xiaofei Liao <br /> ***Proceedings of the 17th International Symposium on Advanced Parallel Processing Technology***, 2026
...
- **[SC 2025]** [TaGNN: An Efficient Topology-aware Accelerator for High-performance Dynamic Graph Neural Network](https://dl.acm.org/doi/epdf/10.1145/3712285.3759818) ```CCF A``` <br />  Hui Yu, Yu Zhang, Ligang He, Bing Peng, **<ins>Jin Zhao</ins>**, Zixiao Wang, Hao Qi, Hai Jin <br /> ***Proceedings of the 2025 International Conference for High Performance Computing, Networking, Storage, and Analysis***, 2025
- **[DAC 2025]** [PairGraph: An Efficient Search-space-aware Accelerator for High-performance Concurrent Pairwise Queries](https://ieeexplore.ieee.org/document/11132889) ```CCF A``` <br /> Yutao Fu, Zhongtian Long, Yu Zhang, Zirui He, **<ins>Jin Zhao</ins>**, Qiyuan Niu, Zixiao Wang, Hai Jin <br /> ***Proceedings of the 62nd IEEE/ACM Design Automation Conference***, 2025
...
- **[APPT 2025]** [Achieving Efficient Temporal Graph Transformation on the GPU](https://link.springer.com/chapter/10.1007/978-981-95-1021-4_20) <br /> Linchen Yu, Zihan Li, **<ins>Jin Zhao (Corresponding author)</ins>**, Longlong Lin, Hengshan Yue <br /> ***Proceedings of the 16th International Symposium on Advanced Parallel Processing Technology***, 2025
...
- **[IEEE TKDE]** [NCSAC: Effective Neural Community Search via Attribute-augmented Conductance](https://ieeexplore.ieee.org/document/11235568) ```CCF A``` <br />  Longlong Lin, Quanao Li, Miao Qiao, Zeli Wang, **<ins>Jin Zhao</ins>**, Rong-Hua Li, Xin Luo, Tao Jia <br /> ***IEEE Transactions on Knowledge and Data Engineering***, 2025
- **[IEEE TKDE]** [Provable Higher-order Graph Clustering: the Power of Peeling-based Approaches](https://ieeexplore.ieee.org/document/11036599) ```CCF A``` <br />  Longlong Lin, Zeli Wang, Rong-Hua Li, Qiyu Liu, Hongchao Qin, **<ins>Jin Zhao</ins>** <br /> ***IEEE Transactions on Knowledge and Data Engineering***, 2025
- **[SSI]** [An Efficient High Throughput System of Hypergraph Neural Network under CPU-GPU Heterogeneous Environments](https://www.sciengine.com/SSI/doi/10.1360/SSI-2024-0282) (in Chinese) <br /> Hui Yu, Yu Zhang, Xintao Li, Zikang Chen, Yingqi Zhao, **<ins>Jin Zhao</ins>**, Hao Qi, Xiaofei Liao, Hai Jin <br /> ***SCIENTIA SINICA Informationis***, 2025
- **[SSI]** [An Efficient Out-of-Core Graph Processing System for Second-Order Random Walks]() (in Chinese) <br /> Yuluo Guo, Zikang Chen, Yu Zhang, **<ins>Jin Zhao</ins>**, Zixiao Wang, Hui Yu, Xiaofei Liao, Hai Jin <br /> ***SCIENTIA SINICA Informationis***, 2025
...
- **[CRAD]** [Review of Key Technologies in Graph Processing Architectures and Systems Software](https://crad.ict.ac.cn/cn/article/pdf/preview/10.7544/issn1000-1239.202220778.pdf) (in Chinese) <br /> Yu Zhang, Xinyu Jiang, Hui Yu, **<ins>Jin Zhao (Corresponding author)</ins>**, Hao Qi, Xiaofei Liao, Hai Jin, Biao Wang, Ting Yu <br /> ***Journal of Computer Research and Development***, 2024
