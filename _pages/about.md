...
- **[ICCD 2026]** [ReHyper: A Redundancy-Eliminated Accelerator for Dynamic Hypergraph Neural Networks]() ```CCF B``` <br /> Zhongtian Long, Mo Zou, Qiyuan Niu, Wenju Zhao, Yutao Fu, Jiaqi Zhai, Shunsen Lv, Zixiao Wang, Yuluo Guo, Yuanyuan Liang, Hongrui Guo, **<ins>Jin Zhao (Corresponding author)</ins>**, Yu Zhang <br /> ***Proceedings of the 44th IEEE International Conference on Computer Design***, 2026
- **[APPT 2026]** [Hardware-Accelerated Streaming Graph Processing with Fast Refinement]() <br /> Jingrui Yuan, Qinggang Wang, Haoran Zhu, **<ins>Jin Zhao</ins>**, Xiaofei Liao <br /> ***Proceedings of the 17th International Symposium on Advanced Parallel Processing Technology***, 2026
...
- **[IEEE TKDE]** [NCSAC: Effective Neural Community Search via Attribute-augmented Conductance]() ```CCF A``` <br />  Longlong Lin, Quanao Li, Miao Qiao, Zeli Wang, **<ins>Jin Zhao</ins>**, Rong-Hua Li, Xin Luo, Tao Jia <br /> ***IEEE Transactions on Knowledge and Data Engineering***, 2025
