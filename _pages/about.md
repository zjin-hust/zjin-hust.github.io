...
- **[ACM TACO]** Jin Zhao; Yu Zhang; Donghao He; Qikun Li; Weihang Yin; Hui Yu; Hao Qi; Xiaofei Liao; Hai Jin; Haikun Liu, Linchen Yu, Zhang Zhan. An Efficient ReRAM-based Accelerator for Asynchronous Iterative Graph Processing. ***ACM Transactions on Architecture and Code Optimization***, 2025.
...
- **[DAC]**	Hui Yu, Yu Zhang, Ligang He, Donghao He, Qikun Li, **<ins>Jin Zhao</ins>**, Xiaofei Liao, Hai Jin, Lin Gu and Haikun Liu. CDA-GNN: A Chain-driven Accelerator for Efficient Asynchronous Graph Neural Network. In Proceedings of the 61st ACM/IEEE Design Automation Conference (DAC’24), 1-6, 2024.
- **[DAC]**	Hui Yu, Yu Zhang, Andong Tan, Chenze Lu, **<ins>Jin Zhao</ins>**, Xiaofei Liao, Hai Jin and Haikun Liu. RTGA: A Redundancy-free Accelerator for High-Performance Temporal Graph Neural Network Inference. In Proceedings of the 61st ACM/IEEE Design Automation Conference (DAC’24), 1-6, 2024.
