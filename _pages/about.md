...
- **[SC 2025]** [TaGNN: An Efficient Topology-aware Accelerator for High-performance Dynamic Graph Neural Network]() ```CCF A``` <br />  Hui Yu, Yu Zhang, Ligang He, Bing Peng, **<ins>Jin Zhao</ins>**, Zixiao Wang, Hao Qi, Hai Jin <br /> ***Proceedings of the 2025 International Conference for High Performance Computing, Networking, Storage, and Analysis***, 2025
...
- **[APPT 2025]** [Achieving Efficient Temporal Graph Transformation on the GPU]() <br /> Linchen Yu, Zihan Li, **<ins>Jin Zhao (Corresponding author)</ins>**, Longlong Lin, Hengshan Yue <br /> ***Proceedings of the 16th International Symposium on Advanced Parallel Processing Technology***, 2025
